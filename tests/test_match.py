...
class TestMatch(unittest.TestCase):
    ...
    def test__match_bibcode_permutations(self):
        ...
        correct_returnDict = {"match": "mismatch",
                              "bibcode": "1900A&A...123..456X"}
        ...
        correct_returnDict = {"match": "partial",
    ...
    def test_match(self):
        ...
        test_bibcodesFromDoi = [("2000ApJ...999..999Z",
                                 "2000ApJ...999..999Z",
                                 "canonical")
                               ]
        test_bibcodesFromBib = [("2000ApJ...999..999Z",
                                 "2000ApJ...999..999Z",
                                 "canonical")
                               ]
        test_returnDict = cm.match(test_input_bibcode,
                                    test_bibcodesFromDoi,
                                    test_bibcodesFromBib)
        correct_returnDict = {"bibcode": "2000ApJ...999..999Z",
                              "errs": {},
                              "match": "canonical"}
        self.assertEqual(test_returnDict, correct_returnDict)
        ...
        test_input_bibcode = "2000ApJ...999..999Z"
        test_bibcodesFromDoi = [("2000ApJ...999..777Q",
                                 "2000ApJ...999..777Q",
                                 "canonical")
                               ]
        test_bibcodesFromBib = []
        test_returnDict = cm.match(test_input_bibcode,
                                    test_bibcodesFromDoi,
                                    test_bibcodesFromBib)
        correct_returnDict = {"bibcode": "2000ApJ...999..777Q",
        ...
        #     no canonical, alternate, or deleted matches
        test_input_bibcode = "2000ApJ...999..999Z"
        test_bibcodesFromDoi = [("1900A&A...123..456X",
                                 "1900A&A...123..456X",
                                 "canonical")
                               ]
        test_bibcodesFromBib = []
        test_returnDict = cm.match(test_input_bibcode,
                                    test_bibcodesFromDoi,
                                    test_bibcodesFromBib)
        correct_returnDict = {"bibcode": "1900A&A...123..456X",
                              "match": "mismatch"}
        self.assertEqual(test_returnDict, correct_returnDict)
        ...
        test_returnDict = cm.match(test_input_bibcode,
                                   test_bibcodesFromDoi,
                                   test_bibcodesFromBib)
        correct_returnDict = {"bibcode": None,
